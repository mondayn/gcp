...
- [summarize using vertex ai](https://github.com/mondayn/gcp/blob/main/vertex/vertex.ipynb): use terraform to create a cloud function that accepts a url and returns a short summary of that url's content.
